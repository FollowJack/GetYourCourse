			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="isPaymentNeeded" title="${message(code: 'course.isPaymentNeeded.label', default: 'Is Payment Needed')}" />

                        <g:sortableColumn property="maxParticipantAmount" title="${message(code: 'course.maxParticipantAmount.label', default: 'Max Participant Amount')}" />
                        <th>Register</th>
				...
				<g:each in="${courseInstanceList}" status="i" var="courseInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${courseInstance.isPaymentNeeded}" /></td>

                        <td>${fieldValue(bean: courseInstance, field: "maxParticipantAmount")}</td>
                        <td><g:link action="register" params="[courseId: courseInstance.id]">Register</g:link></td>

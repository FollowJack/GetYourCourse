...
class ParticipantController {
    ...
    def delete(Long id) {
        ...
        def idsToDelete = CourseParticipant.findAllByParticipant(participantInstance)
        idsToDelete.each{
            def temp = CourseParticipant.findByParticipant(it.participant).delete(flush: true)
        }
